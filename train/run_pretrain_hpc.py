...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--steps-per-stage", type=int, default=1000)
    ...
    parser.add_argument("--positive-size-min", type=int, default=100)
    parser.add_argument("--positive-size-max", type=int, default=300)
    ...
    parser.add_argument("--base-lr", type=float, default=1.6e-4)
    parser.add_argument("--min-lr", type=float, default=1.6e-5)
    ...
    parser.add_argument("--unlabeled-ratio-end-lo", type=float, default=0.5)
    parser.add_argument("--unlabeled-ratio-end-hi", type=float, default=2.5)
